...
kafka_1     | [2015-11-20 05:24:00,058] INFO Client environment:java.class.path=:/kafka_2.9.2-0.8.2.2/bin/../core/build/dependant-libs-2.10.4*/*.jar:/kafka_2.9.2-0.8.2.2/bin/../examples/build/libs//kafka-examples*.jar:/kafka_2.9.2-0.8.2.2/bin/../contrib/hadoop-consumer/build/libs//kafka-hadoop-consumer*.jar:/kafka_2.9.2-0.8.2.2/bin/../contrib/hadoop-producer/build/libs//kafka-hadoop-producer*.jar:/kafka_2.9.2-0.8.2.2/bin/../clients/build/libs/kafka-clients*.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/jopt-simple-3.2.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/kafka-clients-0.8.2.2.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/kafka_2.9.2-0.8.2.2-javadoc.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/kafka_2.9.2-0.8.2.2-scaladoc.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/kafka_2.9.2-0.8.2.2-sources.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/kafka_2.9.2-0.8.2.2-test.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/kafka_2.9.2-0.8.2.2.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/log4j-1.2.16.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/lz4-1.2.0.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/metrics-core-2.2.0.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/scala-library-2.10.4.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/slf4j-api-1.7.6.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/slf4j-log4j12-1.6.1.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/snappy-java-1.1.1.7.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/zkclient-0.3.jar:/kafka_2.9.2-0.8.2.2/bin/../libs/zookeeper-3.4.6.jar:/kafka_2.9.2-0.8.2.2/bin/../core/build/libs/kafka_2.10*.jar (org.apache.zookeeper.ZooKeeper)
